...
/**
 * Recommendation Screen — /recommend
 *
  ...
  if (currentRec?.status === 'accepted') {
    ...
    return (
      <div className="flex-1 flex flex-col p-6">
        ...
        <Link
          href="/"
          className="block w-full py-3 rounded-xl text-sm font-medium text-center mt-6"
    ...
    <div className="flex-1 flex flex-col p-6">
      ...
      {showRejection ? (
        <div className="mt-4 space-y-2 animate-fade-in-up">
          ...
          <button onClick={() => setShowRejection(false)} className="w-full py-2 text-sm" style={{ color: 'var(--foreground-subtle)' }}>
            Cancel
          </button>
        </div>
      ) : (
        <div className="mt-4 space-y-2">
          ...
          <button
            ...
            style={{ background: 'var(--surface)', border: '1px solid var(--border)', color: 'var(--foreground-subtle)' }}
          >
            🔄 Refresh
          </button>
        </div>
